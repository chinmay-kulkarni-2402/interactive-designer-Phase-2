import 'script-loader!./apiconfig.js';
import 'script-loader!./custom_errorlogger.js';
import 'script-loader!./home.js';
import 'script-loader!./codeEditor.js';
import 'script-loader!./postCssParser.js';
import 'script-loader!./webPage.js';
import 'script-loader!./basicBlocks.js';
import 'script-loader!./navbar.js';
import 'script-loader!./countdown.js';
import 'script-loader!./forms.js';
import 'script-loader!./imageEditor.js';
import 'script-loader!./zipExport.js';
import 'script-loader!./customCode.js';
import 'script-loader!./toolbox.js';
import 'script-loader!./tooltip.js';
import 'script-loader!./styleBg.js';
import 'script-loader!./tabs.js';
import 'script-loader!./new_components.js';
import 'script-loader!./source.js';
import 'script-loader!./highchart/custom_chart_nd_common_json.js';
import 'script-loader!./custom-table.js';
import 'script-loader!./custom-carousel.js';
import 'script-loader!./custom-add-new-font-url.js';
import 'script-loader!./custom-loading-page.js';
import 'script-loader!./custom-tab-with-nav.js';
import 'script-loader!./object.js';
import 'script-loader!./custom-video-in.js';
import 'script-loader!./custom_separator.js';
import 'script-loader!./page-setup-manager.js';
import 'script-loader!./hide-on-print.js';
import 'script-loader!./custom_section.js';
import 'script-loader!./marqee-tag.js';
import 'script-loader!./format_text.js';
import 'script-loader!./customJsonTable.js';
import 'script-loader!./background-audio.js';
import 'script-loader!./drawingTool.js';
import 'script-loader!./qr-barcode.js';
import 'script-loader!./custom-shapes.js';
import 'script-loader!./areaBreakComponent.js';
import 'script-loader!./exportMultipleFormats.js';
import 'script-loader!./tableOfContents.js';
import 'script-loader!./linkTrackerPlugin.js';
import 'script-loader!./liveLineChartComponent.js';
import 'script-loader!./subreport.js';
import 'script-loader!./backbutton.js';
import 'script-loader!./video-forms.js';
import 'script-loader!./html2pdf.js';

import '../css/home.css';
import '../css/codeEditor.css';
import '../css/main.css';
import '../css/custom.css';
import '../css/styleBg.css';

window.editor = window.InteractiveDesigner.init({
  height: "100%",
  container: "#editor",
  fromElement: 1,
  allowScripts: 1,
  ...
  plugins: [
    ...
    "webpage-component",
    window.drawingTool,
    window.customChartCommonJson,
    window.flowLayoutComponent,
    window.customTable,
    window.source,
    window.customCarousel,
    window.customNewFontUrl,
    window.customLoadingPage,
    window.customVideoIn,
    window.loadBackButtonComponent,
    window.customSeparator,
    window.customSections,
    window.jsontablecustom,
    window.addFormattedRichTextComponent,
    window.marqueTag,
    window.exportPlugin,
    window.addQRBarcodeComponent,
    window.registerCustomShapes,
    window.customTableOfContents,
    window.addLiveLineChartComponent,
   // window.linkTrackerPlugin,
    window.backgroundMusic,
    // customFlowColumns,
    window.subreportPlugin,
    "basic-block-component",
    "countdown-component",
    "forms-component",
    "video-forms-component",
    "table-component",
    window.newComponents,
    window.object,
    window.customTabWithNav,
    //window.customImage,
